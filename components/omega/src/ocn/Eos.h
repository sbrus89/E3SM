...
class TEOS10Poly75t {
 public:
   ...
   KOKKOS_FUNCTION void operator()(const Array2DReal &SpecVol, I4 ICell, I4 KChunk,
...
class Eos {
 ...
 private:
   ...
   //KOKKOS_FUNCTION void computeSpecVolTEOS10Poly75t(Array2DReal &SpecVol, I4 ICell, I4 KChunk,
   //                                 const Array2DReal &ConservativeTemperature,
   //                                 const Array2DReal &AbsoluteSalinity,
   //                                 const Array2DReal &Pressure);
   //KOKKOS_FUNCTION void computeSpecVolLinear(Array2DReal &SpecVol, I4 ICell, I4 KChunk,
   //                          const Array2DReal &ConservativeTemperature,
   //                          const Array2DReal &AbsoluteSalinity,
   //                          const Array2DReal &Pressure);
